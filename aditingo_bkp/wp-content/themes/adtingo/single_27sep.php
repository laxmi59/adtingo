...
<div class="inner-con-left">
  <p><span class="date">Emailed on: <? $exp=explode(" ",$main_post['schedule_date']); echo $exp[0];?></span><!--<img src="images/313.jpg" />-->
  <? if($comb_fet['clickble_image']=='') $img="313.jpg"; else $img=$main_post['main_image'];?>
...
<div class="inner-con-right">
  ...
  <h3 class="subtit"><?=$main_post['sub_heading ']?></h3>
    ...
    <div class="bottom-bt w-none"><a href="#" class="check-it-out"></a><a href="#" class="email"></a><a href="#" class="share"></a><a href="#" class="retweet"></a></div>
</div>
<div class="clear"></div>
