...
<!--Left content -->
	<div class="content-left">
		...
		<!--<div class="inner-con-left">-->
			...
			<?php /*?><? 	$mon_array=array('01','02','03','04','05','06','07','08','09','10','11','12');
			...
			for($i=0;$i<sizeof($mon_array);$i++){
				...
				if($selnum){?>
					<a href="http://localhost/projects/aditingo/<?=$val?>"><?=$mon1_array[$i]." ".get_the_date('Y')?></a> |
				<? }
			}?><?php */?>
			<?php rewind_posts();
				// get_template_part( 'loop', 'archive' );
			?>
			<?php /*?><dl class="archive-list">
			<?
...
<dt>
<? if($row['clickble_image']=='') $img="no_pic130.gif"; else $img=$row['clickble_image'];?>
<a href="<?=home_url( '/' ).$name?>">
