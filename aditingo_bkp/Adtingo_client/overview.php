...
if(isset($_REQUEST['delid']) && $_REQUEST['delid']!='')
{
 ...
 $SqlCampaign_info="select *,date_format(schedule_date,'%d %b,  %Y') as date ,date_format(date_created ,'%W %b %d,  %Y') as createddate  from tbl_campaigns where status!=0 and clientid=".$Clientid ; 
