...
function GetAllMemberRedordsinfo($arealist="",$gender="",$education="",$incomeval="",$keywordsarry="",$minage="",$maxage="",$zipcodedb="",$sendoption="",$randnnum="")
{
$where=1;
//echo $gender;
if($arealist!="")
...
$Currdate=date("Y-m-d");
   $SqlSearch_result="select *  from tbl_members,tbl_member_metropolitian  where $where and tbl_members.memberid=tbl_member_metropolitian.memberid and Next_campaign_received_date<='".$Currdate."' $randcon";  
$ResSearch_result=$this->ExecuteQuery($SqlSearch_result);
