...
$Currdate=date("Y-m-d");
  $SqlSearch_result="select * from tbl_members,tbl_member_metropolitian  where $where and tbl_members.memberid=tbl_member_metropolitian.memberid and Next_campaign_received_date<='".$Currdate."'";    
