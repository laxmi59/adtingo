...
if($_POST['submitproduct']!="")
{
	...
	if($GETMessResqry)
	{
		...
		header("Location:manage_Campaigns_list2.php?mes=added&clientselect=".$RecCampaign_info['clientid']."");
		exit;
	}
}			
                              ...
                              <tr>
                                <td height="30" colspan="2" align="center"><table border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td>&nbsp;</td>
                                    <td><a href="manage_Campaigns_list2.php?mes=added&amp;clientselect=<?php echo $RecCampaign_info['clientid'];?>"></a>
