...
<form name="clientselection" id="clientselection" action="step1.php" method="post" onsubmit="return checkclientsel();">
                          ...
                          <tr>
                            <td width="50%"  valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" >
                                  ...
                                  <tr>
                                    ...
                                    <td width="70%" align="left"><select name="clientselect" id="clientselect" class="w-165">
                                  ...
                                  <tr>
                                    ...
                                    <td align="left"> <input name="Submit" type="submit" class="button" id="Submit" value="Next" />                        </td>
                                  </tr>
