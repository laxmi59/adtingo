...
$content_error_val="";
	...
	if($_POST['destinationurl']!='' && $_POST['heading']!='' && $headering_error_val=="" &&$subcontent_error_val=="" && $content_error_val=="" && $_POST['text_content']!='')
		{
		...
		else
		{
			...
			if($_POST["destinationurl"]=="")
				...
				else if($_POST["text_content"]!="")
				{
					if(strlen($_POST["text_content"])>250)
					{
					$content_error="Text content should be below 250 chars";
					}
				}
				else
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">                  
				  ...
				  <?php  echo $content_error;?>
                              ...
                              <tr>
                                ...
                                <td align="left"><table width="80%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td align="left"><textarea name="contact_info" id="contact_info" cols="45" rows="5" class="w-238"  onkeydown="countEm(50,'contact_info','myTracker1');" onkeyup="maybeReset(50,'contact_info');"><?php if($RecCampaign_info['contact_info']!="") echo $RecCampaign_info['contact_info'] ;?></textarea><input type='hidden' name='myTracker1' id="myTracker1" /></td>
                                  </tr>
                                  <tr>
                              ...
                              <tr>
                                ...
                                <td align="left"><table width="80%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
									  ...
									  <img src="../Campaign_images/main_image/thumb_images/<?php echo $RecCampaign_info['main_image']; ?>" width="100" height="100" /><?php }?></td>
                                    </tr>
                                  </table></td>
                              </tr>
                              <tr>
