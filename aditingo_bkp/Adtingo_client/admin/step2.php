...
<input type="hidden" name="page" id="page" value="<?php echo $_REQUEST['page']; ?>" />
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
							  ...
							  <tr>
                                ...
                                <td align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td width=""> <input type="text" name="schedule_date" id="schedule_date"
				   ...
				   $dateformat1=explode("-",$dateformat[0]);
				    ...
				    echo $dateformat2; } else echo $_POST['schedule_date']; ?>" 	  class="w-80"  />&nbsp;<a href="javascript:show_calendar('signupForm5.schedule_date');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"><img src="images/calendar.gif"  title='Calender' width="17" height="19" border="0"></a>
