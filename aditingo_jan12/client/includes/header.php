  ...
  <div class="nav">
    ...
    <div class="links">
      <ul>
        ...
        <li><a href="member-profile.php"><span><?php
		$object=new main();
...
{  ?>
 ...
 <?php
	  ...
	  if(($a[basename]=='overview.php') || ($a[basename]=='lnk-activity-overlay.php') || ($a[basename]=='reports.php') || ($a[basename]=='campaign-performance-report.php') || ($a[basename]=='step1.php') || ($a[basename]=='step2.php') || ($a[basename]=='step3.php') || ($a[basename]=='step4.php') || ($a[basename]=='step5.php')|| ($a[basename]=='campaign-show-results.php') || ($a[basename]=='edit-campaign.php') || ($a[basename]=='payment-gateway.php') || ($a[basename]=='template-preview.php') || ($a[basename]=='campaign-comparison.php') || ($a[basename]=='campaign-information.php') || ($a[basename]=='add-own-template.php'))
		{ 
		$overview_class="";
		$campaign_class=="";
		$report_class="";
