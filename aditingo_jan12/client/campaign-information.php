      ...
      <form  action="" method="post" name="signupForm5" id="signupForm5">                              
            <div class="grey-box">
              ...
              <dl class="form">
                ...
                <dd> <input type="radio" name="templatename" id="templatename1" value="1"  <?php if($RecCampaign_info['template_selection']=='1') { ?> checked="checked" <?php } ?> /> 
                  Template 1 
                  <input type="radio" class="m-left5" name="templatename" id="templatename2" value="2" <?php if($RecCampaign_info['template_selection']=='2') { ?> checked="checked" <?php } ?>/> 
                  Template 2 
