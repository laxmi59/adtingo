...
else
{
	...
	else if (!(is_numeric($_POST['CreditCardNumber'])))
	 { 
          ...
          <dl class="form">
			...
			<br/>
			   <span class="red">
                ...
                <dt>Card Number </dt>
                <dd><input   name="CreditCardNumber" id="CreditCardNumber"  tabindex="2" type="text" value="<?php if( $RecGetclients_bill_info['CCNo']!="")	 { echo  $RecGetclients_bill_info['CCNo']; } ?>" />
				<br/>
			   <span class="red">
...
<br/>
          ...
          <a href="template-preview.php?Val=<?php echo base64_encode("id");?>&cid=<?php echo base64_encode($CampaignID);?>" class="left"><img src="images/back.gif" class="m-right5" alt="Back" /></a><input   src="images/save.gif"  type="image" name="steppaymentsubmit_x" id="steppaymentsubmit_x" /> 
             </div>
