...
<a href="campaign-performance-report.php?rid=<?=$camp['campaign_id']?>">Full Results</a> | <a href="edit-campaign.php?cid=<?=$camp['campaign_id']?>">View Campaign</a></span>
          ...
          <td valign="middle" class="cellCenter" ><strong><?=$opn2?>%</strong><br />
 <span><?=$getreport->uniqueOpensCount?></span>
 </td>
          <td valign="middle" class="cellCenter"><strong><?=round($getreport->totalClicksPercent, 2)?>%</strong><br />
 <span><?=$getreport->totalClicksCount?></span>
</td>
          <td valign="middle" class="cellCenter"><strong><?=round($getreport->totalBouncePercent,2)?>%</strong><br />
<span><?=$getreport->totalBounceCount?></span>
</td>
           <td valign="middle" class="cellCenter"><strong><?=round($getreport->unsubscribeResponsesPercent,2)?>%</strong><br />
<span><?=$getreport->unsubscribeResponsesCount?></span> 
</td>
          <td valign="middle" class="cellCenter"><strong><?=round($getreport->complaintResponsesPercent,2)?>%</strong><br />
<span><?=$getreport->complaintResponsesCount?></span></td>
    ...
    Averages across all <?=sizeof($dd)?> campaigns
          ...
          <td width="92" valign="middle" class="cellCenter" ><strong><?=round($open_total/sizeof($dd),2)?>%
          </strong></td>
          <td width="83" valign="middle" class="cellCenter"><strong><?=round($click_total/sizeof($dd),2)?>%
          </strong></td>
          <td width="89" valign="middle" class="cellCenter"><strong><?=round($bounce_total/sizeof($dd),2)?>%
          </strong></td>
           <td width="112" valign="middle" class="cellCenter"><strong><?=round($unsub_total/sizeof($dd),2)?>%
          </strong></td>
          <td width="105" valign="middle" class="cellCenter"><strong><?=round($compl_total/sizeof($dd),2)?>%</strong></td>
        </tr>
        <tr  >
