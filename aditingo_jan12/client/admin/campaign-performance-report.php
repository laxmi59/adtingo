...
<table width="95%" border="0" cellspacing="0" cellpadding="0">
 <tr>
   ...
   <tr>
		<td height="20" align="left" ><p class="bread"><a href="manage_reports.php?uid=<?=$_GET[uid]?>">Reports</a><span  class="breadArrow">&nbsp;</span>Campaign Performance Report</p></td>
  </tr>
  <tr><td  class="content-header"><?=$recCampdetails['campaign_name']?></td></tr>
  <tr><td><p><? $dt=$recCampdetails['schedule_date']; echo date('l F j, Y', strtotime($dt))?></p></td></tr>
   </table></td>
   ...
   <tr>
    ...
    <tr> 
		...
		<td><a href="lnk-activity-overlay.php?uid=<?=$_GET[uid]?>&rid=<?=$_GET['rid']?>" id="linkClickActivity"><b>Link Activity &amp; Overlay</b></a><br>
