...
?>
	<dt><a href="<?php echo home_url( '/' ).$pop_row['post_name']?>"><img src="<?php echo home_url( '/' ); ?>client/Campaign_images/clickble_image/thumb_images/<?=$img?>" width="60" height="60" /></a></dt>
