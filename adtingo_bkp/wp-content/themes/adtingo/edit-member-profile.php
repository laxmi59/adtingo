...
<div class="content-cont-inner">
  ...
  <div class="content-left">
    <form onsubmit="return editformvalidate()" method="post" name="regisstration" action="">
      <div id="div-Form">
        ...
        <div class="register-form">
          <dl class="form1">
            ...
            <dt>Password</dt>
            <dd>
              <input type="text" value="<?php echo isset($_POST['pass'])?$_POST['pass']:stripslashes($GetMembersResult['password']); ?>" id="pass" name="pass">
            ...
            <dd>
              ...
              &nbsp;
              <select name="year" id="year"><option value="">Year</option><?php echo $birthdateyears;?></select>
            </dd>
            <dt>Gender</dt>
            <dd class="gender">
