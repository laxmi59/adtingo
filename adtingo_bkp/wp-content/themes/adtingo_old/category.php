						...
						while($sel_rel_fet=mysql_fetch_array($sel_rel)){ 
							...
							$i=1;
								if($spost_cont['main_image']<>""){ 
									$dispimg="client/Campaign_images/main_image/thumb_images/".$spost_cont['main_image'];
				...
				while($terms_relation=mysql_fetch_array($terms_SubCat_Relation)){
					...
					$i=1;
						if($combfet['main_image']<>""){ 
									$dispimg="client/Campaign_images/main_image/thumb_images/".$combfet['main_image'];
...
<? $i=0;
	...
	if($term_slug['slug']==$file){ 
		...
		if($comb_fet['main_image']<>""){ 
									$dispimg="client/Campaign_images/main_image/thumb_images/".$comb_fet['main_image'];
								}if($combfet['clickble_image']<>""){
