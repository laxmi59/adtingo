...
if($_REQUEST['cid']!="")
{
	...
	$GetTemplateinfoRec=$object->FetchArray($GetTemplateinfoQry);
		...
		$desinationurl1="";
		 ...
		 $facebook_link1="";
	if($facebook_link!="") 
	 $facebook_share_link1="<a href='".$facebook_link."' target='_blank'><img src='http://clients.adtingo.com/Campaign_templates/Campaign_template1/images/content-buttonfbshare.jpg' alt='' border='0' width='95' height='30'></a>";	
		 else
		 $facebook_share_link1="";
		 ...
		 $twitter_link1="";
		  if($twitter_link!="")
		 $twitter_share_link1="<a href='".$twitter_link."' target='_blank'><img src='http://clients.adtingo.com/Campaign_templates/Campaign_template1/images/content-buttonretweet.jpg' alt='' border='0' width='95' height='30'></a>";	
		 else
		 $twitter_share_link1="";
		...
		$GetCatName=$object->Getmetropolitianareaname($RecCampaign_Seg_list_info['area_list']);
		  ...
		  $linkUrl10 = stripslashes($GetTemplateinfoRec['link_url10']);
			...
			$mailMessage = str_replace("#SHAREFACEBOOKLINK#", "$facebook_share_link1", "$mailMessage");
			$mailMessage = str_replace("#SHARETWITTERLINK#", "$twitter_share_link1", "$mailMessage");
