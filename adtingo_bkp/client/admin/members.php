      ...
      <table width="95%" border="0" cellspacing="0" cellpadding="0">
          ...
          <td class="form-bg2"><table width="100%" cellpadding="0" cellspacing="1" id="customerGrid_table">
            <thead>
              ...
              <!--<td width="6%" class="headings" align="left"><strong>ID</strong></td>-->
                <td width="17%" align="left" class="headings">Username <a href="members.php?page=<?php echo $page;?>&field=name&order=ASC&limit=<?php echo $limit;?>"><img src="images/up.gif"  /></a><a href="members.php?page=<?php echo $page;?>&field=name&order=DESC&limit=<?php echo $limit;?>"><img src="images/down.gif"  /></a></td>
		...
		<tr>
             <!--  <td class="<?php echo $class;?>" align="left"> </td>-->
                <td align="left" class="<?php echo $class;?>"><?php echo stripslashes($RecGetCustomersInfo['username']);?></td>
