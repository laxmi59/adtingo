                    ...
                    <table width="100%"  border="0" cellpadding="1" cellspacing="0" class="border">
                      <tr>
                        <td><table width="100%"  border="0" cellpadding="3" cellspacing="0" class="td">
							...
							<tr align="left">
                                <td >Title</td>
                                <td align="justify" ><?php echo stripslashes($ResGetUserFlag['title']); ?></td>
						   	</tr>
							<? if($ResGetUserFlag['img']<>''){?>
							<tr align="left">
                                <td >Title</td>
                                <td align="justify" ><img src="articles/<?=$ResGetUserFlag['img']?>" width="110" height="110" /></td>
						   	</tr>
							<? }?>
							 	<tr align="left">
                                <td >Content</td>
							...
							<tr align="left">
                                <td >Date</td>
                                <td ><?php echo stripslashes($ResGetUserFlag['date']); ?></td>
						   	</tr>
