	...
	if($_POST['destinationurl']!='' && $_POST['heading']!='' && $_POST['text_content']!='')
		...
		if($_FILES['main_image']['name']!='')
		{
				...
				$_SESSION['campaign']['main_image']=$_FILES['main_image']['name']; 
				 $Insert_main_image_Qry=sprintf("update tbl_campaigns  set main_image='%s' where campaign_id=%d",$object->stripper($main_image_lastname),$object->stripper($CampaignID));  
      ...
      <form  action="" method="post" name="submitform5" id="submitform5" enctype="multipart/form-data" >                              
            <div class="grey-box">
              ...
              <dl class="form">
                ...
                <dt>Heading</dt>
                <dd><input type="text" name="heading" id="heading" value="<?php if($RecCampaign_info['heading']!="") echo $RecCampaign_info['heading'] ;?>"  onkeypress="return checkvalue();" /><br /><div id="headerchars" style="display:none;" class="errer-mess2">You have exceeded more than 30 characters</div> <small>(30 Characters Max)</small>
				<br/>
				<span class="red">
		     ...
		     <?php if($content_error!="") echo $content_error;?>
                ...
                <dt>Coantact Info</dt>
                <dd><textarea name="contact_info" id="contact_info" cols="" rows="5"><?php if($RecCampaign_info['contact_info']!="") echo $RecCampaign_info['contact_info'] ;?></textarea><br /> <small>(Physical Address, Webiste URL)</small></dd> 
