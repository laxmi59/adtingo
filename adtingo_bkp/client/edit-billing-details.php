      	 ...
      	 <div class="account-settings-top">
			...
			<br/>
			   <span class="red">
                ...
                <dt>Card Number </dt>
                <dd><input   name="CreditCardNumber" id="CreditCardNumber"  tabindex="2" type="text" value="<?php echo stripslashes($RecGetclients_bill_info['CCNo']);  ?>" />
				<br/>
			   <span class="red">
