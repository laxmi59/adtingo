...
<title><?php echo SITETITLE."Manage Campaigns"?></title>
 ...
 <div class="body">
      ...
      <form  action="payment-gateway.php" method="post">                              
			...
			<dl class="small-form">
			 ...
			 <dt>Category</dt>
             <dd><?php $catName=$Intrest_and_activitise[$RecCampaign_info['category_option']]; 
			 			if($catName!="")
						echo $catName;
						else
						echo "N/A";
           ...
           <h3 class="grad-box">Step 1.2 Delivery<?php if($RecCampaign_info['status']!=5) {?><a href="step5.php?cid=<?php echo base64_encode($RecCampaign_info['campaign_id']);?>"  ><img src="images/edit.gif" alt="Edit this campaign" class="edit-btn" border="0"  /></a><?php } ?></h3> 
          <dl class="small-form">
             
             
             <dt>Campaign Schedule Date</dt>
             <dd><?php if($RecCampaign_info['schedule_date']!="")
          ...
          <h3 class="grad-box">Step 1.3 List Segmentation <?php if($RecCampaign_info['status']!=5) {?><a href="step2.php?cid=<?php echo base64_encode($RecCampaign_info['campaign_id']);?>"  ><img src="images/edit.gif" alt="Edit this campaign" class="edit-btn" border="0"  /></a><?php } ?></h3> 
          <dl class="small-form">
             <dt>Minimum Age</dt>
             <dd><?php if($RecCampaign_Seg_list_info['minimum_age']!="0" && $RecCampaign_Seg_list_info['minimum_age']!="") { echo $RecCampaign_Seg_list_info['minimum_age'];?> years<?php } else echo "N/A";?></dd> 
              <dt>Maximum Age</dt>
             <dd><?php if($RecCampaign_Seg_list_info['maxmum_age']!="0" && $RecCampaign_Seg_list_info['minimum_age']!="") { echo $RecCampaign_Seg_list_info['maxmum_age'];?> years<?php } else echo "N/A";?></dd> 
              <dt>Gender</dt>
          ...
          <h3 class="grad-box">Step 1.4 List Segmentation <?php if($RecCampaign_info['status']!=5) {?><a href="step2.php?cid=<?php echo base64_encode($RecCampaign_info['campaign_id']);?>"  ><img src="images/edit.gif" alt="Edit this campaign" class="edit-btn" border="0"  /></a><?php } ?></h3> 
          <dl class="small-form"><?php */?>
          ...
          <h3 class="grad-box">Step 1.4 List Segmentation<?php if($RecCampaign_info['status']!=5) {?> <a href="step4.php?cid=<?php echo base64_encode($RecCampaign_info['campaign_id']);?>"  ><img src="images/edit.gif" alt="Edit this campaign" class="edit-btn" border="0"  /></a><?php } ?></h3> 
          <dl class="small-form">
             <dt>Send to all</dt>
             <dd><?php
...
<h3 class="grad-box">Campaign Information <a href="add-own-template.php?cid=<?php echo base64_encode($RecCampaign_info['campaign_id']);?>"  ><img src="images/edit.gif" alt="Edit this campaign" class="edit-btn" border="0"  /></a></h3> 
          <dl class="small-form">
             <dt>Destination URL</dt>
			  ...
			  <dd>
				<?php
					if($RecCampaign_info['sub_heading']!="" && $RecCampaign_info['sub_heading']!="Array")
			  ...
			  <dd>
				<?php
					if($RecCampaign_info['text_content']!="" && $RecCampaign_info['text_content']!="Array")
					echo stripslashes($RecCampaign_info['text_content']);
					else
					echo "N/A";
				 ?>
			  </dd>
			  <?php /*?><dt>Coantact Info</dt>
			  <dd>
				<?php
