...
function campaign_comparison()
{
	//alert("aa");
	var sErrStr = ""; 
   	var sFieldName = "";
	
	if(trim(document.getElementById('jumpMenu').value)=='')
	{
		sErrStr +=" Select Campaign List \n";
		if(sFieldName == "")
		sFieldName="jumpMenu";
	}
	if (sErrStr != "")
...
function deleteCampaign(cid,page)
{
	var agree = confirm('Are you sure you want to delete this Campaign?');
	if(agree)
	  window.location.href="overview.php?delid="+cid+"&page="+page;
