...
$setpath="http://clients.adtingo.com";
 include('/var/www/client/includes/dbfiler_cron.php'); 
//include('pager.php');
...
function GetCampaignSearchResult($arealist="",$gender="",$education="",$incomeval="",$keywordsarry="",$minage="",$maxage="",$zipcodedb="")
{
...
function GetAllMemberRedordsinfo($arealist="",$gender="",$education="",$incomeval="",$keywordsarry="",$minage="",$maxage="",$zipcodedb="",$sendoption="",$randnnum="",$shddate="")
{
$where=1;
//echo $gender;
if($arealist!="")
...
$Currdate=date("Y-m-d");
   $SqlSearch_result="select *  from tbl_members,tbl_member_metropolitian  where $where and tbl_members.memberid=tbl_member_metropolitian.memberid and Next_campaign_received_date<='".$shddate."' $randcon";  
$ResSearch_result=$this->ExecuteQuery($SqlSearch_result);
...
Braintree_Configuration::merchantId('37qf33gqg8sz7mpc');
Braintree_Configuration::publicKey('grhj3gwz6wk46b4y');
Braintree_Configuration::privateKey('x52wt963j4xbzd4p');
