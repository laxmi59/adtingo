					  ...
					  <tr>
						...
						<td align="left"><table border="0" cellspacing="0" cellpadding="0">
						  <tr>
							...
							<?php /*?><input type="button" name="button" id="button" value="back" class="button" onclick="javascript:window.location='step5.php?Val=<?php echo base64_encode("id");?>&cid=<?php echo base64_encode($CampaignID);?>'" /><?php */?>
							<input type="button" name="button" id="button" value="back" class="button" onclick="javascript:window.location='step5.php?cid=<?php echo base64_encode($CampaignID);?>'" />
							</td>
							<td>&nbsp;</td>
