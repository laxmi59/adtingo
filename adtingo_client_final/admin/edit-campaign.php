                                ...
                                <tr>
                                  <td height="30" colspan="2" align="left" class="table-tab"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        ...
                                        <input type="button" name="button7" id="button7" value="Edit" class="button" onclick="javascript:window.location='step1.php?cid=<?php echo base64_encode($RecCampaign_info['campaign_id']);?>'" />                                        </td>
                                      </tr>
                                    </table></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td height="30" colspan="2" align="left" class="table-tab"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        ...
                                        <td align="right"><?php if($RecCampaign_info['status']!=5) {?><a href="step2.php?cid=<?php echo base64_encode($RecCampaign_info['campaign_id']);?>"  ></a>
                                ...
                                <tr>
                                  <td height="30" colspan="2" align="left" class="table-tab"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        ...
                                        <td align="right"><?php if($RecCampaign_info['status']!=5) {?><a href="step3.php?cid=<?php echo base64_encode($RecCampaign_info['campaign_id']);?>"  ></a>
                                          <input type="button" name="button7" id="button7" value="Edit" class="button" onclick="javascript:window.location='step3.php?cid=<?php echo base64_encode($RecCampaign_info['campaign_id']);?>'" /><?php }?>                                          </td>
                                      </tr>
                                    </table></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td height="30" colspan="2" align="left" class="table-tab"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        ...
                                        <td align="right">
										<?php if($RecCampaign_info['status']!=5) {?><a href="step3.php?cid=<?php echo base64_encode($RecCampaign_info['campaign_id']);?>"  ></a><input type="button" name="button4" id="button4" value="Edit" class="button" onclick="javascript:window.location='step3.php?cid=<?php echo base64_encode($RecCampaign_info['campaign_id']);?>'" /><?php }?>										</td>
                                      </tr>
                                    </table></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td height="30" colspan="2" align="left" class="table-tab"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        <td align="left" valign="middle" class="p-t3">Step 1.4 List Segmentation </td>
                                        <td align="right">
										<?php if($RecCampaign_info['status']!=5) {?><a href="step3.php?cid=<?php echo base64_encode($RecCampaign_info['campaign_id']);?>"  ></a><input type="button" name="button3" id="button3" value="Edit" class="button" onclick="javascript:window.location='step5.php?cid=<?php echo base64_encode($RecCampaign_info['campaign_id']);?>'" /><?php }?>										</td>
                                      </tr>
                                    </table></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td height="30" colspan="2" align="left" class="table-tab"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        ...
                                        <td align="right">
										<a href="campaign-information.php?cid=<?php echo base64_encode($RecCampaign_info['campaign_id']);?>"  ></a><input type="button" name="button2" id="button2" value="Edit" class="button" onclick="javascript:window.location='campaign-information.php?cid=<?php echo base64_encode($RecCampaign_info['campaign_id']);?>'" />										</td>
                                      </tr>
                                    </table></td>
                                </tr>
                                <tr>
			...
			if($GetTemplateinfoRec['TemplateName']!="")
				...
				echo "N/A"; ?></td>
                                ...
                                <tr>
                                  <td height="30" colspan="2" align="left" class="table-tab"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        ...
                                        <td align="right">
										<a href="add-own-template.php?cid=<?php echo base64_encode($RecCampaign_info['campaign_id']);?>"  ></a><input type="button" name="button" id="button" value="Edit" class="button" onclick="javascript:window.location='add-own-template.php?cid=<?php echo base64_encode($RecCampaign_info['campaign_id']);?>'" />										</td>
                                      </tr>
                                    </table></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  ...
                                  <td align="left"> <?php
					if($RecCampaign_info['destination_url']!="" && $RecCampaign_info['destination_url']!="Array")
				 ...
				 ?> </td>
                                ...
                                <tr>
                                  ...
                                  <td align="left"><?php
					if($RecCampaign_info['heading']!="" && $RecCampaign_info['heading']!="Array")
				 ...
				 ?></td>
                                ...
                                <tr>
                                  ...
                                  <td align="left"> <?php
					if($RecCampaign_info['sub_heading']!="" && $RecCampaign_info['heading']!="Array")
				 ...
				 ?> </td>
                                ...
                                <tr>
                                  ...
                                  <td align="left"><?php
					if($RecCampaign_info['text_content']!="" && $RecCampaign_info['heading']!="Array")
				 ...
				 ?> </td>
								...
								<tr>
                                  ...
                                  <td align="left"><?php
					if($RecCampaign_info['map_address']!="" && $RecCampaign_info['map_address']!="Array")
				 ...
				 ?> </td>
								...
								<tr>
                                  ...
                                  <td align="left"><?php
					if($RecCampaign_info['map_city']!="" && $RecCampaign_info['map_city']!="Array")
				 ...
				 ?> </td>
								...
								<tr>
                                  ...
                                  <td align="left"><?php
					if($RecCampaign_info['map_state']!="" && $RecCampaign_info['map_state']!="Array")
				 ...
				 ?> </td>
                                ...
                                <tr>
                                  ...
                                  <td align="left"><?php
					if($RecCampaign_info['map_zipcode']!="" && $RecCampaign_info['map_zipcode']!="Array")
				 ...
				 ?></td>
								...
								<tr>
                                  ...
                                  <td align="left"><?php
					if($RecCampaign_info['phone']!="" && $RecCampaign_info['phone']!="Array")
				 ...
				 ?></td>
								...
								<tr>
                                  ...
                                  <td align="left"><?php
					if($RecCampaign_info['websiteurl']!="" && $RecCampaign_info['websiteurl']!="Array")
