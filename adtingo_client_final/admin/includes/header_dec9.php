...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<form name="loginform" id="loginform" target="_blank" action="http://adtingo.com/wp-login.php" method="post">
		...
		<input type="submit" style="background:none; border:none; color:#9FD7FF; cursor:pointer; text-decoration:underline; font-family:Arial,Helvetica,sans-serif" name="wp-submit" id="wp-submit" value="WordPress Admin" tabindex="100" />
</form>   
