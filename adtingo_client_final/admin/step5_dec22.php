							   ...
							   <tr>
							     ...
							     <td align="left" colspan="2"><table border="0" cellspacing="0" cellpadding="0">
                                   <tr>
									 ...
									 <input type="button" name="button" id="button" value="back" class="button" onclick="javascript:window.location='step3.php?Val=<?php echo base64_encode("id");?>&cid=<?php echo base64_encode($CampaignID);?>'" />
									 </td>
                                     <td>&nbsp;</td>
                                     <td>
