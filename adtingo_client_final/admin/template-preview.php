...
<img src="http://clients.adtingo.com/Campaign_templates/Campaign_template2/images/content-buttonfbshare.jpg" alt="" border="0" width="95" height="30"></a>';
	...
	$citygridlink=$RecCampaign_info['destination_url'];
...
$campainid=base64_encode($CampaignID);
	...
	$postdesinationurl = $RecCampaign_info['destination_url']."?action_target=listing_profile&listing_id=$RecCampaign_info[listing_id]&client_ip=184.73.167.196&reference_id=1&publisher=0905768917&placement=home&format=xml";
