...
<title><?php echo SITETITLE1 ?></title>
...
<div class="home-box" ><div class="home-banner"><a href="index.php" class="logo"></a><a href="tour.php" class="tour"></a><a href="examples.php" class="examples"></a><a href="pricing.php" class="pricing"></a>
 <?php if($_SESSION['clientid']){ $reg="member-profile.php";}else{ $reg="resigtration.php";}?>
<a href="<?php echo $reg;?>" class="singup"></a><a href="<?php echo $reg;?>" class="freejoin"></a>
