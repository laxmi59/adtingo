...
function gettotalrecords(arealist,minage,maxage,gender,income,zip,radious,datesent,random_number)
{
	...
	for (var i=0; i < document.signupForm2.gender.length; i++)
	 ...
	 req.open("GET","GetTotalMemberRecords.php?minage="+minage+"&maxage="+maxage+"&gendersel="+rad_val+"&income="+income+"&area_list="+arealist+"&shddate="+datesent+"&random_number="+random_number,true);
	 req.send(null);
...
{?>disabled="disabled" <?php } ?> onchange="return gettotalrecords(<?php echo $RecCampaign_Seg_list_info['area_list'];?>,document.signupForm2.minage.value,document.signupForm2.maxage.value,document.signupForm2.gender.value,document.signupForm2.income.value,1,2,'<?php echo $shddate2;?>','');"   /> <input type="text" class="w-60" id="maxage" name="maxage" <?php if($RecCampaign_info['status']==5)
{?>disabled="disabled" <?php } ?> onchange="return gettotalrecords(<?php echo $RecCampaign_Seg_list_info['area_list'];?>,document.signupForm2.minage.value,document.signupForm2.maxage.value,document.signupForm2.gender.value,document.signupForm2.income.value,1,2,'<?php echo $shddate2;?>','');"    value="<?php if($RecCampaign_Seg_list_info['maxmum_age']!="0")
...
{?>disabled="disabled" <?php } ?>   name="gender" onclick="return gettotalrecords(<?php echo $RecCampaign_Seg_list_info['area_list'];?>,document.signupForm2.minage.value,document.signupForm2.maxage.value,document.getElementById('gender1').value,document.signupForm2.income.value,1,2,'<?php echo $shddate2;?>','');" id="gender1" value="male" <?php echo $malechkstatus; ?><?php if($chkstatus!="") echo $chkstatus;?>  /> Male <input type="radio" <?php if($RecCampaign_info['status']==5)
{?>disabled="disabled" <?php } ?> name="gender" id="gender2" class="m-left5" value="female" <?php echo $femalechkstatus; ?> onclick="return gettotalrecords(<?php echo $RecCampaign_Seg_list_info['area_list'];?>,document.signupForm2.minage.value,document.signupForm2.maxage.value,document.getElementById('gender2').value,document.signupForm2.income.value,1,2,'<?php echo $shddate2;?>','');"  /> Female <input type="radio" <?php if($RecCampaign_info['status']==5)
{?>disabled="disabled" <?php } ?> class="m-left5"  name="gender" id="gender3" value="both" <?php echo $bothchkstatus; ?>  onclick="return gettotalrecords(<?php echo $RecCampaign_Seg_list_info['area_list'];?>,document.signupForm2.minage.value,document.signupForm2.maxage.value,document.getElementById('gender3').value,document.signupForm2.income.value,1,2,'<?php echo $shddate2;?>','');" /> Both
                </dd>
                
 				<dt>Income</dt>
				<dd><select name="income" id="income" <?php if($RecCampaign_info['status']==5)
{?>disabled="disabled" <?php } ?> onchange="return gettotalrecords(<?php echo $RecCampaign_Seg_list_info['area_list'];?>,document.signupForm2.minage.value,document.signupForm2.maxage.value,document.signupForm2.gender.value,document.signupForm2.income.value,1,2,'<?php echo $shddate2;?>','');"  >
