 ...
 <div class="body">
      ...
      <form  action="" method="post" id="signupForm2" name="signupForm2">                              
            <div class="grey-box">
              ...
              <div class="tno-rec">Total Number Of Records: <strong>
			  <?php 
			  $val=array();
			  		  
echo  $SearchResult=$object->GetCampaignSearchResult($RecCampaign_Seg_list_info['area_list'],$RecCampaign_info['category_option'],'','','','',$val); ?></strong></div>
              <dl class="form">
                <dt>Age</dt>
                <dd>
