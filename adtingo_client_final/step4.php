...
<title><?php echo SITETITLE."Step 1.4: List Segmentation"?></title>
...
<?php if($RecCampaign_info['status']==5)
                  ...
                  <?php }?>
          <a href="step2.php?Val=<?php echo base64_encode("id");?>&cid=<?php echo base64_encode($CampaignID);?>" class="left"><img src="images/back.gif" class="m-right5" alt="Back" /></a>
		  <?php if($RecCampaign_info['status']==5)
			{?>
