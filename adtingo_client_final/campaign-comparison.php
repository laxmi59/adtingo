...
<title><?php echo SITETITLE."Campaign Comparison Report"?></title>
...
<!-- banner end-->
<?php if($_GET[msg]==1){ $errormsg="Select two or more Campaigns to campare";}?>
<!--body start-->
 <div class="body">
      ...
      <form action="campaign-show-results.php" method="post" onsubmit="return campaign_comparison();">                              
			...
			if($deliveredCount==0){ continue;}else{?>
					...
					<?php }}?>
                 </select> <br /><br /><span class="red"><?php echo $errormsg; ?></span></dt>
                  </dl>
             </div>
