...
include("includes/push2Highrise.php");
 ...
 $p->pushContact($_POST);
	...
	include_once('includes/storm.php');
			...
			// dont change this number..
				$templateId=1476;
			// dont change this number.
			$tt[0] = array("address" => $_POST['email']);
...
<title><?php echo SITETITLE."Client Regitration"?></title>
...
<input type="hidden" name="sSubject" value="" id="sSubject" />
<input type="hidden" name="sLastName" value="" id="sLastName" />
<input type="hidden" name="sPhone" value="" id="sPhone" />
<input type="hidden" name="sZip" value="" id="sZip" />
<input type="hidden" name="sCity" value="" id="sCity" />
<input type="hidden" name="sStreet" value="" id="sStreet" />
<input type="hidden" name="sState" value="" id="sState" />
<input type="hidden" name="sCountry" value="" id="sCountry" />
<input type="hidden" name="staff_comment" value="" id="staff_comment" />
...
<input type="hidden" name="usererr" />
			  ...
			  <?php
                ...
                <dt> </dt>
                <dd>
				<!--<input src="images/btn_create-my-account.png" name="submit" id="submit" value="submit"  type="image"/>-->
				<input type="submit" name="submit" value="CREATE MY ACCOUNT" class="submit-bg" />
				</dd>
            </dl>
