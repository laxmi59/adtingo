...
<title><?php echo SITETITLE."Step 1.2: List Segmentation"?></title>
      ...
      <form  action="" method="post" name="signupForm5" id="signupForm5">                              
            ...
            <h3 class="grad-box">Schedule Message</h3>            
                <div class="small-form"> 
                  ...
                  <input type="text" name="schedule_date" <?php if($RecCampaign_info['status']==5)
