          ...
          <p> <?php  $dt=$camp['schedule_date']; echo date('l F j, Y', strtotime($dt))?> </p>
            ...
            <table class="goalSummary" width="100%" cellpadding="0" cellspacing="0">
             ...
             <table class="tableHeader"  width="100%" cellpadding="0" cellspacing="0">       
				...
				?>
				<tr>
					<td><?php echo $getreport->linkReport[$i]->url?><br /><input type="text" name="bar<?php echo $i?>" style="height:3px;<?php if($bar_color==0) echo 'width:450px; background:none;';else echo 'width:'.$bar_color.'px; background:#A4D1FF;'?>; width:450" /></td>		<td><?php echo $getreport->linkReport[$i]->uniqueClicks?></td>
