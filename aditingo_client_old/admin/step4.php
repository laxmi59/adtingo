                        ...
                        <thead>
                          ...
                          <tr>
                            <td width="12%" align="left" class="tr2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                <td height="30" colspan="2" align="left" class="table-tab">Zip Codes</td>
                              </tr>
                              <tr>
				  ...
				  <?php  echo $specifyzipcode_area_error;?>
                              ...
                              <tr>
                                ...
                                <td align="left"><table border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td><a href="step3.php?cid=<?php echo base64_encode($CampaignID);?>">
                                    ...
                                    <td>&nbsp;</td>
                                    <td>
									<a href="step5.php?Val=<?php echo base64_encode("id");?>&cid=<?php echo base64_encode($CampaignID);?>">
									<input type="button" value="Skip the step" id="submitproduct2" class="button" name="submitproduct2" /></a></td>
                                  </tr>
                                </table></td>
                              </tr>
                            </table>
