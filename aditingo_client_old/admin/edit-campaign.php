          ...
          <tr>
            <td width="83%" height="100" align="left" class="tr5"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                  <td height="30" colspan="2" align="left" class="table-tab"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        ...
                                        <td align="right"><a href="step1.php?cid=<?php echo base64_encode($RecCampaign_info['campaign_id']);?>"  >
                                          <input type="button" name="button7" id="button7" value="Edit" class="button" />
                                          </a></td>
                                      </tr>
                                    </table></td>
                                </tr>
                                ...
                                <tr>
                                  <td height="30" colspan="2" align="left" class="table-tab"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        ...
                                        <td align="right"><a href="step2.php?cid=<?php echo base64_encode($RecCampaign_info['campaign_id']);?>"  >
                                          <input type="button" name="button7" id="button7" value="Edit" class="button" />
                                          </a></td>
                                      </tr>
                                    </table></td>
			  ...
			  ?></td>
                                ...
                                <tr>
                                  <td height="30" align="left">Education</td>
                                  <td align="left"><?php 
			 ...
			 ?></td>
                                ...
                                <tr>
                                  <td height="30" align="left">Keywords/Activities </td>
                                  <td align="left"><?php				 	
                                ...
                                <tr>
                                  <td height="30" colspan="2" align="left" class="table-tab"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        ...
                                        <td align="right">
										<a href="step3.php?cid=<?php echo base64_encode($RecCampaign_info['campaign_id']);?>"  ><input type="button" name="button4" id="button4" value="Edit" class="button" /></a>
										</td>
                                      </tr>
                                    </table></td>
                                </tr>
                                ...
                                <tr>
                                  <td height="30" colspan="2" align="left" class="table-tab"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        ...
                                        <td align="right">
										<a href="step4.php?cid=<?php echo base64_encode($RecCampaign_info['campaign_id']);?>"  ><input type="button" name="button3" id="button3" value="Edit" class="button" /></a>
										</td>
                                      </tr>
                                    </table></td>
                                </tr>
                                ...
                                <tr>
                                  <td height="30" colspan="2" align="left" class="table-tab"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        ...
                                        <td align="right">
										<a href="campaign-information.php?cid=<?php echo base64_encode($RecCampaign_info['campaign_id']);?>"  ><input type="button" name="button2" id="button2" value="Edit" class="button" /></a>
										</td>
                                      </tr>
                                    </table></td>
                                </tr>
                                ...
                                <tr>
                                  <td height="30" colspan="2" align="left" class="table-tab"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        ...
                                        <td align="right">
										<a href="add-own-template.php?cid=<?php echo base64_encode($RecCampaign_info['campaign_id']);?>"  ><input type="button" name="button" id="button" value="Edit" class="button" /></a>
										</td>
                                      </tr>
                                    </table></td>
                                </tr>
