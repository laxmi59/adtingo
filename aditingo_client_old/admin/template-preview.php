          ...
          <td><table width="100%" border="0" cellpadding="0" cellspacing="0" id="customerGrid_table">
            <thead>
              ...
              <tr>
                ...
                </table>  <form  action="payment-gateway.php" method="post">  
...
?></td>
                              ...
                              <tr>
                                ...
                                <td align="left"><table border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td><a href="add-own-template.php?Val=<?php echo base64_encode("id");?>&cid=<?php echo base64_encode($CampaignID);?>">
                                      <input type="button" name="button" id="button" value="back" class="button" />
                                    </a></td>
                                    <td>&nbsp;</td>
                                    <td><a href="manage_Campaigns_list2.php?mes=added&clientselect=<?php echo $RecCampaign_info['clientid'];?>"><input type="button" value="Next" id="submitproduct" class="button" name="submitproduct" /></a></td>
                                    <td>&nbsp;</td>
                                    <td><a href="manage_Campaigns_list2.php?mes=added&clientselect=<?php echo $RecCampaign_info['clientid'];?>">
                                    <input type="button" name="button2" id="button2" value="approve" class="button" />
                                    </a></td>
                                  </tr>
                                </table></td>
                              </tr>
