 ...
 <div class="error-msg"><?php if($_REQUEST['msg']=="update") { ?>
      ...
      <div class="account-settings">
         	...
         	<div class="account-settings-bottom">
                ...
                <dl class="small-form">
                      ...
                      <dt>Last Name</dt>
                       <dd>
					   		<?php
							if($RecGetclients_bill_info['BillLastname']!="")
								 echo stripslashes($RecGetclients_bill_info['BillLastname']);
							else
								 echo "----";
							 ?>
                ...
                <dd>
				 <?php
					if($RecGetclients_bill_info['CCNo']!="")
						echo stripslashes($RecGetclients_bill_info['CCNo']);
					else
						 echo "----";
				 ?>
		   ...
		   <br/>
                ...
                <dd>
				<?php
					if($RecGetclients_bill_info['CCVNo']!="")
						echo $RecGetclients_bill_info['CCVNo'];
					else
						 echo "----";
				 ?>
				</dd> 
