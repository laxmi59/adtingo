...
if(isset($_POST['steppreview_x'])){
	//print_r($_POST);
	$getClient="select * from `tbl_billing_details` where clientid='".$_SESSION['clientid']."'";
	echo "select * from `tbl_billing_details` where clientid='".$_SESSION['clientid']."'";
...
<?php /*?><?php 
			...
			?>
			<a href="add-own-template.php?Val=<?php echo base64_encode("id");?>&cid=<?php echo base64_encode($CampaignID);?>" class="left"><img src="images/back.gif" class="m-right5" alt="Back" /></a><input   src="images/next.gif"  type="image" /><a href="overview.php?msg=added"><img class="m-left5" src="images/approve-bt.gif" alt="Approve"/></a>
			<?php }	?><?php */?>
          <a href="add-own-template.php?Val=<?php echo base64_encode("id");?>&cid=<?php echo base64_encode($CampaignID);?>" class="left"><img src="images/back.gif" class="m-right5" alt="Back" /></a><input   src="images/next.gif"  type="image" /><!--<a href="payment-gateway.php?Val=<?php echo base64_encode("id");?>&cid=<?php echo base64_encode($CampaignID);?>"><img class="m-left5" src="images/approve-bt.gif" alt="Approve"/></a>-->
		  <input src="images/approve-bt.gif"  type="image" name="steppreview_x" id="steppreview_x" />
		  <!--<input type="image" src="images/approve-bt.gif" value="Approve" name="approve_test"  id="approve_test" />-->
