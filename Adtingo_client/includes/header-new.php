...
$TitleName="Privacy Policy";
 ?>
<div class="welcome-box" ><div class="inner-banner"><a href="index.php" class="logo"></a><a href="tour.php" class="tour"></a><a href="examples.php" class="examples"></a><a href="pricing.php" class="pricing"></a><a href="resigtration.php" class="singup"></a><div class="title"><?php echo $TitleName;?></div></div></div>