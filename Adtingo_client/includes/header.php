...
{  ?>
 ...
 <?php
	  ...
	  if(($a[basename]=='overview.php') || ($a[basename]=='lnk-activity-overlay.php') || ($a[basename]=='reports.php') || ($a[basename]=='campaign-performance-report.php') || ($a[basename]=='step1.php') || ($a[basename]=='step2.php') || ($a[basename]=='step3.php') || ($a[basename]=='step4.php') || ($a[basename]=='step5.php')|| ($a[basename]=='campaign-show-results.php') || ($a[basename]=='edit-campaign.php') || ($a[basename]=='payment-gateway.php') || ($a[basename]=='template-preview.php') || ($a[basename]=='campaign-comparison.php') || ($a[basename]=='campaign-information.php') || ($a[basename]=='add-own-template.php') || ($a[basename]=='campaign_confirmation.php') || ($a[basename]=='create-campaign.php'))
		{ 
		$overview_class="";
		$campaign_class=="";
		$report_class="";
