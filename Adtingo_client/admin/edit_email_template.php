...
$iid=$Tid;
	...
	if($_FILES['cre_temp']['name']<>''){
		...
		$seltemp=$object->ExecuteQuery("select * from tbl_email_template_content where Tid=$iid");
		$seltempfet=$object->FetchArray($seltemp);
		$unlinkfile="../Campaign_templates/Campaign_template1/".$seltempfet[new_temp];
		//unlink($unlinkfile);
		$upd=sprintf("update tbl_email_template_content set new_temp='%s' where Tid=%d",$object->stripper($filename),$object->stripper($iid)); 
	...
	if($_FILES['preview_temp']['name']<>''){
		...
		set_time_limit(0);
		$filename = stripslashes($_FILES['preview_temp']['name']);
            ...
            <td width="83%" height="100" align="left" class="tr5"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <form action="" method="post" name="profilrfrm" enctype="multipart/form-data" onsubmit="return validatetemplateform();" >
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td height="28" align="left" class="form-headings">Template Details</td>
                  </tr>
                  <tr>
                    <td class="form-bg2">
				  ...
				  <tr>
					...
					<tr>
					 ...
					 <tr>
					  ...
					  <td align="left"><input type="text" name="template_name" id="template_name" size="33" value="<?php if( $RecGetEmailTemplates['TemplateName']!="") echo  stripslashes($RecGetEmailTemplates['TemplateName']);?>" /></td>
					</tr>
					<tr>
					...
					<tr>
					  ...
					  <td align="left">
					  <img width="83" height="100" src="http://clients.adtingo.com/Campaign_templates/Campaign_template1/images/thumb_images/<?php echo $RecGetEmailTemplates['preview']?>" /><br /><br />
					  <input type="file" name="preview_temp" id="preview_temp" />					  </td>
					</tr>
					<tr>
                                  <td height="30" align="left"><strong>Template Type </strong></td>
                                  <td align="left">
								  	<input type="radio" <?php if($RecGetEmailTemplates['template_type']==1){?> checked="checked"<?php }?> name="template_type" id="template_type" value="1" />   Vertical
									<input type="radio" <?php if($RecGetEmailTemplates['template_type']==2){?> checked="checked"<?php }?> name="template_type" id="template_type" value="2" /> Wide
								  </td>
                                </tr>
					</table></td>
				  </tr>
