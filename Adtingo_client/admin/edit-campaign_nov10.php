                                  ...
                                  <td height="30" colspan="2" align="left" class="table-tab"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        ...
                                        <td align="right"><a href="step2.php?cid=<?php echo base64_encode($RecCampaign_info['campaign_id']);?>"  ></a>
                                          <input type="button" name="button7" id="button7" value="Edit" class="button" onclick="javascript:window.location='step2.php?cid=<?php echo base64_encode($RecCampaign_info['campaign_id']);?>'" />                                          </td>
                                      </tr>
                                    </table></td>
                                </tr>
                                <tr>
                                  ...
                                  <td height="30" colspan="2" align="left" class="table-tab"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        ...
                                        <td align="right"><a href="step3.php?cid=<?php echo base64_encode($RecCampaign_info['campaign_id']);?>"  ></a>
                                          <input type="button" name="button7" id="button7" value="Edit" class="button" onclick="javascript:window.location='step3.php?cid=<?php echo base64_encode($RecCampaign_info['campaign_id']);?>'" />                                          </td>
                                      </tr>
                                    </table></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td height="30" colspan="2" align="left" class="table-tab"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        ...
                                        <td align="right">
										<a href="step3.php?cid=<?php echo base64_encode($RecCampaign_info['campaign_id']);?>"  ></a><input type="button" name="button4" id="button4" value="Edit" class="button" onclick="javascript:window.location='step4.php?cid=<?php echo base64_encode($RecCampaign_info['campaign_id']);?>'" />										</td>
                                      </tr>
                                    </table></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td height="30" colspan="2" align="left" class="table-tab"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        ...
                                        <td align="right">
										<a href="step4.php?cid=<?php echo base64_encode($RecCampaign_info['campaign_id']);?>"  ></a><input type="button" name="button3" id="button3" value="Edit" class="button" onclick="javascript:window.location='step5.php?cid=<?php echo base64_encode($RecCampaign_info['campaign_id']);?>'" />										</td>
                                      </tr>
                                    </table></td>
                                </tr>
                                <tr>
			...
			if($GetTemplateinfoRec['TemplateName']!="")
				...
				echo "N/A"; ?></td>
				 ...
				 ?> </td>
								...
								<tr>
								  <td height="30" align="left">Apt</td>
								  <td align="left"><?php
					if($RecCampaign_info['map_apt']!="")
					echo $RecCampaign_info['map_apt'];
					else
					echo "N/A";
				 ?></td>
							    </tr>
