...
<input type="hidden" name="main2" id="main2" value="<?php if($RecCampaign_info['lng']!="") echo $RecCampaign_info['lng'] ;?>"><div id="map" style="width: 500px; height: 400px; display:none;"></div>
				  ...
				  <?php  echo $content_error;?>
                              ...
                              <tr>
                                ...
                                <td align="left"><table width="80%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td align="left"><input type="text" name="map_address" id="map_address" value="<?php if($RecCampaign_info['map_address']!="") echo $RecCampaign_info['map_address'] ;?>"/></td>
                                  </tr>
                              ...
                              <tr>
                                ...
                                <td align="left"><table width="80%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td align="left"><input type="text" name="map_apt" id="map_apt" value="<?php if($RecCampaign_info['map_apt']!="") echo $RecCampaign_info['map_apt'] ;?>"/></td>
                                  </tr>
                              ...
                              <tr>
                                ...
                                <td align="left"><table width="80%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td align="left"><input type="text" name="map_city" id="map_city" value="<?php if($RecCampaign_info['map_city']!="") echo $RecCampaign_info['map_city'] ;?>"/></td>
                                  </tr>
							  ...
							  <tr>
                               ...
                               <tr>
                                ...
                                <td align="left"><table width="80%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td align="left"><input type="text" name="map_state" id="map_state" value="<?php if($RecCampaign_info['map_state']!="") echo $RecCampaign_info['map_state'] ;?>" onblur="lat_lng()"/></td>
                                  </tr>
							  ...
							  <tr>
                                ...
                                <td align="left"><table width="80%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td align="left"><input type="text" name="map_zipcode" id="map_zipcode" value="<?php if($RecCampaign_info['map_zipcode']!="") echo $RecCampaign_info['map_zipcode'] ;?>"/></td>
                                  </tr>
							   ...
							   <tr>
                                ...
                                <td align="left"><table width="80%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td align="left"><input type="text" name="phone" id="phone" value="<?php if($RecCampaign_info['phone']!="") echo $RecCampaign_info['phone'] ;?>"/></td>
                                  </tr>
								  <?php if($phone_error!="") {?>
				  ...
				  <?php  echo $phone_error;?>
							   ...
							   <tr>
                                ...
                                <td align="left"><table width="80%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td align="left"><input type="text" name="websiteurl" id="websiteurl" value="<?php if($RecCampaign_info['websiteurl']!="") echo $RecCampaign_info['websiteurl'] ;?>"/></td>
                                  </tr>
