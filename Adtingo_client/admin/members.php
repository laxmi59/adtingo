...
$message="fdel";
	$mid=$_REQUEST['delid'];
	$delMetroIds=$object->DeleteData("tbl_member_metropolitian","memberid=$mid");
...
<td align="right"  class="padbot5"><a href="edit-member.php?page=<?php echo $page;?>">Add Member </a></td>
  ...
  <tr class="grey-bg">
    ...
    <td align="left" class="content-header">&nbsp;</td>
<td align="right"  valign="bottom"><input type="button" name="export_members" value="Export" onclick="javascript:window.location='csv.php'" /></td>
  </tr>
</table>
<table width="95%" border="0" cellspacing="0" cellpadding="0">
