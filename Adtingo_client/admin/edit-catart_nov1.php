                          ...
                          <tr>
                            <td width="12%" align="left" class="tr2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
								...
								?>
                                  <option value="<?php echo $sel_terms_fet['term_id']?>" <?php if($QryGetUserDetailsRec['cat_id']==$sel_terms_fet['term_id']) echo "selected='selected'"?> ><?php echo $sel_terms_fet['name']?></option>
								 <?php }?>
                                </select>                                </td>
                              </tr>
							  <tr>
