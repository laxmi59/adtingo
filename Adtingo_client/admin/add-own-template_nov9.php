  ...
  <td><table width="100%" border="0" cellpadding="0" cellspacing="0" id="customerGrid_table">
	<thead>
	  ...
	  <tr>
		...
		<form  action="" method="post" name="submitform5" id="submitform5" enctype="multipart/form-data"  onsubmit="retun lat_lng();" >
...
<input type="hidden" name="main2" id="main2" value="<?php echo $main2 ;?>"><div id="map" style="width: 500px; height: 400px; display:none;"></div>
					...
					<td width="12%" align="left" class="tr2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
					  ...
					  <tr>
						...
						<td align="left"><table width="80%" border="0" cellspacing="0" cellpadding="0">
						  <tr>
							<td align="left">
							<input type="text" name="heading" class="textfill2" id="heading" value="<?php echo $heading ;?>" onkeypress="return checkvalue();" />
		  ...
		  <?php  echo $heading_error;?>
					  ...
					  <tr>
						...
						<td align="left"><table width="80%" border="0" cellspacing="0" cellpadding="0">
						  <tr>
							<td align="left"><input type="text" name="subheading" class="textfill2" id="subheading" value="<?php echo $subheading ;?>" onkeypress="return checksubheadingval();"  />
		  ...
		  <?php  echo $subheading_error;?>
					  ...
					  <tr>
						...
						<td align="left"><table width="80%" border="0" cellspacing="0" cellpadding="0">
						  <tr>
							<td align="left">
							<textarea name="text_content" id="text_content" cols="45" rows="5" class="w-238" onkeydown="countEm(250,'text_content','myTracker');" onkeyup="maybeReset(250,'text_content');"><?php echo $text_content;?></textarea><input type='hidden' name='myTracker' id="myTracker" /><br /><div id="test_content" style="display:none;" class="red-normal">You have exceeded more than 250 characters</div></td>
						  </tr>
						  <tr>
		  ...
		  <?php  echo $content_error;?>
					  ...
					  <tr>
						...
						<td align="left"><table width="80%" border="0" cellspacing="0" cellpadding="0">
						  <tr>
							<td align="left"><input type="text" class="textfill2" name="map_address" id="map_address" value="<?php echo $map_address;?>"/></td>
						  </tr>
					  ...
					  <tr>
						...
						<td align="left"><table width="80%" border="0" cellspacing="0" cellpadding="0">
						  <tr>
							<td align="left"><input type="text" class="textfill2" name="map_city" id="map_city" value="<?php echo $map_city ;?>"/></td>
						  </tr>
					  ...
					  <tr>
					   ...
					   <tr>
						...
						<td align="left"><table width="80%" border="0" cellspacing="0" cellpadding="0">
						  <tr>
							<td align="left"><input type="text" class="textfill2" name="map_state" id="map_state" value="<?php echo $map_state ;?>" onblur="lat_lng()"/></td>
						  </tr>
					  ...
					  <tr>
						...
						<td align="left"><table width="80%" border="0" cellspacing="0" cellpadding="0">
						  <tr>
							<td align="left"><input type="text" class="textfill2" name="map_zipcode" id="map_zipcode" value="<?php echo $map_zipcode ;?>"/></td>
						  </tr>
					   ...
					   <tr>
						...
						<td align="left"><table width="80%" border="0" cellspacing="0" cellpadding="0">
						  <tr>
							<td align="left"><input type="text" class="textfill2" name="phone" id="phone" value="<?php echo $phone;?>"/></td>
						  </tr>
						  <?php if($phone_error!="") {?>
		  ...
		  <?php  echo $phone_error;?>
					   ...
					   <tr>
						...
						<td align="left"><table width="80%" border="0" cellspacing="0" cellpadding="0">
						  <tr>
							<td align="left"><input type="text" class="textfill2" name="websiteurl" id="websiteurl" value="<?php echo $websiteurl ;?>"/></td>
						  </tr>
					  ...
					  <tr>
						...
						<td align="left"><table width="80%" border="0" cellspacing="0" cellpadding="0">
						  <tr>
							<td align="left"><input name="destinationurl" type="text" class="textfill2" id="destinationurl" value="<?php echo $destinationurl ;?>" /></td>
						  </tr>
						  <tr>
