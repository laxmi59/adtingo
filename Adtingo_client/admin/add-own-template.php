...
if(isset($_POST['submitproduct']))
{
	...
	if($_POST['destinationurl']!='' && $_POST['heading']!='' && $headering_error_val=="" &&$subcontent_error_val=="" && $_POST['text_content']!='' && $image_error_val=='' )
	{
  ...
  <td><table width="100%" border="0" cellpadding="0" cellspacing="0" id="customerGrid_table">
	<thead>
	  ...
	  <tr>
		...
		<form  action="" method="post" name="submitform5" id="submitform5" enctype="multipart/form-data"  onsubmit="lat_lng();" >
		  ...
		  <?php  echo $content_error;?>
					  ...
					  <tr>
					   ...
					   <tr>
						...
						<td align="left"><table width="80%" border="0" cellspacing="0" cellpadding="0">
						  <tr>
							<td align="left"><input type="text" class="textfill2" name="map_state" id="map_state" value="<?php if($map_state<>'Array') echo stripslashes($map_state) ; else '';?>" onblur="lat_lng()"/></td>
						  </tr>
