...
function gettotalrecords(arealist,minage,maxage,gender,income,zipcode,radious,datesent)
{
	 var req=createRequest();
	 req.open("GET","GetTotalMemberRecords_admin.php?minage="+minage+"&maxage="+maxage+"&gendersel="+gender+"&income="+income+"&area_list="+arealist+"&zipcode="+zipcode+"&radious="+radious+"&shddate="+datesent,true);
	 req.send(null);
...
<?php if($RecCampaign_info['status']!=5)
{?>   
gettotalrecords(<?php echo $RecCampaign_Seg_list_info['area_list'];?>,'<?php echo $RecCampaign_Seg_list_info['minimum_age'];?>','<?php echo $RecCampaign_Seg_list_info['maxmum_age'];?>','<?php echo $RecCampaign_Seg_list_info['gender'];?>',<?php echo $RecCampaign_Seg_list_info['income'];?>,'<?php echo $RecCampaign_Seg_list_info['zipcode'];?>','<?php echo $RecCampaign_Seg_list_info['zipcode_miles'];?>','<?php echo $shddate2;?>');
<?php } else {?>
