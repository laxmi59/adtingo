...
<!--body-->
 <div class="body">
      ...
      <form  action="payment-gateway.php" method="post">                              
          ...
          <h3 class="grad-box">Step 1.4 List Segmentation <?php if($RecCampaign_info['status']!=5) {?><a href="step3.php?cid=<?php echo base64_encode($RecCampaign_info['campaign_id']);?>"  ><img src="images/edit.gif" alt="Edit this campaign" class="edit-btn" border="0"  /></a><?php } ?></h3> 
          <dl class="small-form">
          ...
          <h3 class="grad-box">Step 1.5 List Segmentation<?php if($RecCampaign_info['status']!=5) {?> <a href="step4.php?cid=<?php echo base64_encode($RecCampaign_info['campaign_id']);?>"  ><img src="images/edit.gif" alt="Edit this campaign" class="edit-btn" border="0"  /></a><?php } ?></h3> 
          <dl class="small-form">
             <dt>Send to all</dt>
             <dd><?php
